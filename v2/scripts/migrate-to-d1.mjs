...
const YEAR_MIN = 2000;
const YEAR_MAX = 2026;
const CHUNK_SIZE = 100; // D1 rejects statements > ~100 KB; at ~11 cols * varying-length strings, 100 rows is a safe ceiling
...
function main() {
  ...
  // D1 wraps file execution in its own transaction — explicit
  // BEGIN/COMMIT is rejected. We emit plain statements.
  const lines = [];
